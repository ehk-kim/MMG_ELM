...
#iqtree <- get_tips("iqtree_russ_full_its2.treefile", "iqtree_tips.csv")
```
...
russ_tree <- drop.tip(russ_tree, c("Lactifluus_gerardii_AV05-375","Lactifluus_volemus_UE09.08.2004-5","Lactifluus_piperatus_UE09.08.2004-6","Lactifluus_longisporus_AV99-197_BB_00.1519","Lacttifluus_edulis_AV99-041","Lactarius_nodosicystidiosus_BB97-072","Lactifluus_phlebophyllus_BB00-1388","R_variicolor_ISOTYPE_FL","Lactarius_chromospermus_AV99-174","Lactifluus_emergens_AV99-005","Lactifluus_velutissimus_AV99-185","Lactifluus_deceptivus_AV04-181"
))
