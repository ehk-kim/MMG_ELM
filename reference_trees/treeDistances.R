#####
# This script aims to output a similarity score between a selected reference tree
# and a selected input tree, following the scoring metric from Nye et al. 2006.
#
# If you don't provide absolute paths, make sure that this script is in the same
# folder as your trees.
# 
